      ...
      <AnimatePresence>
        {showMenu && (
          <motion.ul
            ...
            className="flex flex-col justify-around min-h-[40vh] w-full pt-6 pb-8 pl-14 absolute top-19 left-0 bg-[var(--darker)] text-white z-20 text-4xl font-medium font-[family-name:var(--font-jost)]"
          >
            {navItems.map((item) => (
              <motion.li
                key={item.id}
