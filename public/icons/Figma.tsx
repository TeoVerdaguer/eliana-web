const Figma = () => {
  return (
    <a href="https://www.figma.com/" target="_blank" className="h-12 w-12 text-center flex justify-center items-center group hover:bg-[#30323b] rounded-lg transition-colors duration-300">
